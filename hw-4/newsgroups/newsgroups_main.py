from newsgroups_classifier import Classifier
...
def index_page(text = "", prediction_message = ""):
    ...
    return render_template('newsgroups_templates_simple_page.html', text = text, prediction_message = prediction_message)


if __name__ == "__main__":
    app.run(host = '185.104.114.122', port = 80, debug = False)
